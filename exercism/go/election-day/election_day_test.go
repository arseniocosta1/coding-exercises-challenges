...
func BenchmarkDisplayResult(b *testing.B) {
	var r string
	for i := 0; i < b.N; i++ {
		r = DisplayResult(&ElectionResult{
			Name:  "John",
			Votes: 5,
		})
	}
...
func BenchmarkDisplayResult2(b *testing.B) {
	var r string
	for i := 0; i < b.N; i++ {
		r = DisplayResult2(&ElectionResult{
			Name:  "John",
			Votes: 5,
		})
	}
...
func BenchmarkDisplayResult3(b *testing.B) {
	var r string
	for i := 0; i < b.N; i++ {
		r = DisplayResult3(&ElectionResult{
			Name:  "John",
			Votes: 5,
		})
	}
